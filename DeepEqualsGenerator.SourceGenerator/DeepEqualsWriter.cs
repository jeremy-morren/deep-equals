...
internal class DeepEqualsWriter
{
    ...
    public string Generate(IReadOnlyList<ITypeSymbol> topLevelTypes)
    {
        ...
        _writer.WriteLine("namespace DeepEqualsGenerator");
    ...
    private void GenerateMethods(IReadOnlyList<ITypeSymbol> topLevelTypes)
    {
